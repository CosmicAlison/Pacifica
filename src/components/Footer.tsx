      ...
      <footer className="max-w-screen-2xl mx-auto border-b-8 border-secondaryBrown px-5 max-[400px]:px-3">
        <div className="flex justify-center gap-24 text-center mt-12 max-[800px]:flex-col max-[800px]:gap-10">
          <div className="flex flex-col gap-1">
            ...
            <p className="text-lg max-sm:text-base">Delivery Policy</p>
          </div>
          ...
          <div className="flex flex-col gap-1">
            <h3 className="text-2xl font-bold max-sm:text-xl">Categories</h3>
            <p className="text-lg max-sm:text-base">Bottoms</p>
            <p className="text-lg max-sm:text-base">Tops</p>
            <p className="text-lg max-sm:text-base">Accessories</p>
            <p className="text-lg max-sm:text-base">Dresses</p>
          </div>
        </div>
        <div className="flex flex-col gap-8 my-20">
          <p className="flex justify-center items-center text-2xl gap-2 max-sm:text-xl">Worldwide / English <HiChevronDown /></p>
          <h2 className="text-6xl font-light text-center max-sm:text-5xl">PACIFICA</h2>
